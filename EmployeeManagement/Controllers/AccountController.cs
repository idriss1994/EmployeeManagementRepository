...
namespace EmployeeManagement.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string token)
        {
            ...
            if (user == null)
            {
                ViewBag.ErrorTitle = $"The user ID {userId} is invalide";
            ...
            ViewBag.ErrorTite = "Email can not be confirmed";
            return View("Error");
        }
        ...
        public async Task<IActionResult> ExternalLoginCallBack(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                if(email != null)
                {
                    if (user == null)
                    {
                        ...
                        var token = await _userManager.GenerateEmailConfirmationTokenAsync(user);
                        var comfirmationEmail = Url.Action("ConfirmEmail", "Account",
                                                            new { userId = user.Id, token = token }, Request.Scheme);
                        _logger.Log(LogLevel.Warning, comfirmationEmail);
                        ViewBag.ErrorTitle = "Registration successful";
                        ViewBag.ErrorMessage = "Befor you can login, please confirm your email" +
                                          ", by clicking on the confirmation link we have emailed you ";
                        return View("Error");
            ...
            ViewBag.ErrorMessage = "Please contact support on idriss1994@gmail.com";
